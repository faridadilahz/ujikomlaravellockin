        ...
        <div class="account-grid">
            ...
            <div class="profile-card">
                <div class="avatar-box">
                    <img src="{{ asset('assets/img/logosss.png') }}" alt="Avatar Admin" class="avatar-img" />
                </div>
                <h2 class="profile-name">{{ $user->name ?? 'Admin Seruli' }}</h2>
                <p class="profile-email">{{ $user->email ?? 'adminseruli@gmail.com' }}</p>
