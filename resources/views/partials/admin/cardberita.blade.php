...
<div class="news-card" onclick="window.location.href='{{ route('admin.berita.show', $item->id) }}'" />
    ...
    <div class="news-card-body">
        ...
        <div class="news-card-footer">
            ...
            <div class="action-buttons">
                ...
                <button type="button" class="news-cta btn-edit" onclick="event.stopPropagation(); window.location.href='{{ route('admin.berita.edit', $item->id) }}';">
                    <span>Edit Berita</span>
                </button>

                <!-- Tombol Hapus (Form Method DELETE) -->
                <form action="{{ route('admin.berita.destroy', $item->id) }}" method="POST" style="width: 100%;" onclick="event.stopPropagation();" onsubmit="return confirm('Yakin ingin menghapus berita ini?');">
                    @csrf
                    @method('DELETE')
